...
app.config['SQLALCHEMY_DATABASE_URI'] = os.getenv('DATABASE_URL', 'postgresql://postgres:UsbaSruVYpGjwTuYNsDdOplcZRcxHLGz@switchyard.proxy.rlwy.net:36564/railway')
